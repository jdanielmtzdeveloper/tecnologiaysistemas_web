...
<body class="login-page" background="fondo.png">
<div class="hidden"><?php include('assets/itsolution24/img/iconmin/membership/membership.svg');?></div>
  ...
  <section class="login-box">
      ...
      <form id="login-form" action="login.php" method="post">       
        ...
        <div class="form-group">
          <div class="input-group">
            ...
            <input type="text" class="form-control" value="ingsislara1@gmail.com" placeholder="Email / Phone No." name="username">
          </div>
        </div>
    ...
    <div class="copyright text-center">
      <p>&copy; <a href="https://www.tecnologiaysistemas.com.mx">Tecnología y Sistemas</a></p>
    </div>
  </section>
