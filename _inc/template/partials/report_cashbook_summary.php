    ...
    <tbody>
      ...
      <tr>
        <td class="w-50 bg-gray text-right">
          ...
          <?php echo trans('label_today_income'); ?>
        </td>
        <td class="w-50 bg-gray text-right">
          <?php
      ...
      <tr class="bg-red">
        <td class="w-50 text-right">
          ...
          <?php echo trans('label_today_expense'); ?> (-)
        </td>
        <td class="w-50 text-right">
          <?php
      ...
      <tr class="bg-yellow">
        <td class="w-50 text-right">
          <h4><b><?php echo trans('label_today_closing_balance'); ?></b></h4>
        </td>
        <td class="w-50 text-right">
          <h4><b><?php echo currency_format($cash_in_hand); ?></b></h4>
        </td>
      </tr>
    </tbody>
  </table>
