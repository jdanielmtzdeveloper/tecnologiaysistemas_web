...
function get_pagos_tarjeta_credito($from=null, $store_id=null)
{
	$register_model = registry()->get('loader')->model('income');
	return $register_model->getTotalTarjetaCredito($from,$store_id);
}

function get_pagos_tarjeta_debito($from=null, $store_id=null)
{
	$register_model = registry()->get('loader')->model('income');
	return $register_model->getTotalTarjetaDebito($from,$store_id);
}